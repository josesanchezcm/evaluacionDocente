<?php 
    ...
    $_SESSION['cveGru']=$_POST['cveGru'];
    $_SESSION['cveMat']=$_POST['cveMat'];
    $_SESSION['cvePro']=$_POST['cvePro'];
    $_SESSION['cveImp']=$_POST['cveImp'];
 ?>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="reporte_evaluacion.php" id="generar"><i class="fa fa-print fa-fw"></i> Imprimir</a>
                        </li>                             
